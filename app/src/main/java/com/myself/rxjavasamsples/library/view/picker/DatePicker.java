...
import com.myself.rxjavasamsples.library.view.picker.util.DateUtils;
...
public class DatePicker extends WheelPicker {
    ...
    private int startYear = 1970, endYear = 2050, endMonth = -1, endDay = -1;
                ...
                public void onSelected(int selectedIndex, String item) {
                    ...
                    if (selectedYear >= endYear) {//月份限制
                        if (endMonth > -1) {
                            ...
                            monthView.setItems(months, position - 1);
                        }
                    } else if (monthView.getItemsCount() < 12) {
                        final ArrayList<String> months = new ArrayList<String>();
                        for (int i = 1; i <= 12; i++) {
                            months.add(DateUtils.fillZore(i));
                        }
                        monthView.setItems(months, selectedMonth - 1);
                    }
