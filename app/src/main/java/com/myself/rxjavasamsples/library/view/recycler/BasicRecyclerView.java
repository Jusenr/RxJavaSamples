package com.myself.rxjavasamsples.library.view.recycler;
...
import com.myself.rxjavasamsples.library.view.recycler.animators.BasicItemAnimator;
import com.myself.rxjavasamsples.library.view.recycler.layoutmanager.InnerGridLayoutManager;
import com.myself.rxjavasamsples.library.view.recycler.layoutmanager.InnerLinearLayoutManager;
import com.myself.rxjavasamsples.library.view.recycler.listener.OnItemClickListener;
import com.myself.rxjavasamsples.library.view.recycler.listener.OnItemLongClickListener;
...
//                    ((GridLayoutManager) manager).setSmoothScrollbarEnabled(true);
        ...
        //添加间隔线
//        recyclerview-flexibledivider-1.2.6
        if (has_row_divider) {
